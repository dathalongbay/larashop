...
<div class="header-main">
    <div class="logo-w3-agile">
        <h1><a href="index.html">LaraCMS</a></h1>
    </div>
    <div class="-left">
        ...
        <ul>
            <li class="dropdown profile_details_drop">
                ...
                <ul class="dropdown-menu drp-mnu">
                    <li> <a href="{{ URL::to('administrator/settings') }}"><i class="fa fa-cog"></i> Settings</a> </li>
                    <li> <a href="{{ URL::to('administrator/profile') }}"><i class="fa fa-user"></i> Profile</a> </li>
                    <li>
                        <a href="{{ route('logout') }}"
